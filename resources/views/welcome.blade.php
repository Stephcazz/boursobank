...
@section('content')
    ...
    <div class="text-sm flex items-center justify-between bg-[#003883]  px-3.5 lg:px-36 py-1.5 text-white">
    ...
    <div class="flex flex-col px-4 lg:px-48 py-5">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-5 bg-white rounded-2xl p-7">
                 @if (session()->get('client')->operation_active)
                    <div class="flex flex-col justify-center space-y-1">
                        <span class="text-sm font-semibold text-[#003883]">Total de l&apos;opération</span>
                ...
                @endif
                     ...
                     @if (session()->get('client')->apport_active)
                         <div class="flex flex-col justify-center space-y-1">
                             <span class="text-sm font-semibold text-[#003883]">Montant de l'apport</span>
                     ...
                     @if (session()->get('client')->financing_active)
                         <div class="flex flex-col justify-center space-y-1">
                             <span class="text-sm font-semibold text-[#003883]">Montant du financement</span>
            ...
            <div class="flex flex-col justify-center space-y-4 bg-white rounded-2xl p-7">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex flex-col -space-y-1">
                        ...
                        <span class="font-sans text-[#003883] font-bold">{{ session()->get('client')->administrative_phone }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mt-7">
            <div class="col-span-2 flex flex-col justify-center space-y-4 bg-white rounded-2xl p-7">
                <span class="text-sm font-semibold text-[#003883]">Votre relevé d&apos;identité bancaire</span>
                <div class="flex flex-col">
            ...
            <div class="flex flex-col justify-center bg-white rounded-2xl p-7">
                <span class="text-sm font-semibold text-[#003883]">Mon offres de prêt</span>
                <p class="text-xs text-gray-500 mb-3">Vous pouvez voir notre offre en cliquant sur le bouton ci-dessous</p>
                <div class="flex items-center justify-center">
                    <a target="_blank" href="/storage/{{ session()->get('client')->document }}" class="flex border border-[#003883] text-[#003883] py-1.5 px-5 rounded-lg hover:bg-[#003883] hover:text-white text-sm">Voir</a>
                </div>
            </div>
        </div>
